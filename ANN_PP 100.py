...
dataset = pd.read_excel('Load 100 exp.xlsx')
...
history_mse = ann.fit(X_train, y_train, batch_size = 32, epochs = 30000, callbacks = [early_stopping_monitor], verbose = 0, validation_split = 0.2)
...
plt.title('Load-Displacement Curve for PP100%')
